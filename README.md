...
```mermaid
gantt
    title 存在主义：西西弗斯的周报计划
    dateFormat  YYYY-MM-DD
    axisFormat  %m-%d

    section 觉醒阶段
    意识到荒谬性           :done,    a1, 2024-01-01, 3d
    寻找生命意义的PPT       :done,    a2, after a1, 7d
    在深夜怀疑一切         :active,  a3, 2024-01-05, 10d

    section 循环挣扎
    推石头上山 (Sprint 1)  :crit,    s1, 2024-01-10, 15d
    石头滚落 (Bug 触发)     :crit,    s2, after s1, 1d
    反思劳动的无用性       :         s3, after s2, 5d
    重新定义“西西弗斯是快乐的” :      s4, after s3, 8d
    推石头上山 (Sprint 2)  :crit,    s5, after s4, 15d

    section 终极交付
    与荒谬达成和解         :         f1, 2024-02-15, 10d
    提交一份空的工作汇报    :milestone, f2, after f1, 0d
    在无意义中享受咖啡     :active,  f3, after f2, 5d
```
